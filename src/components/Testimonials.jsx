  ...
  return (
    <div className="testimonial-stars flex gap-0.5 mb-5">
      {Array.from({ length: count }).map((_, i) => (
        <svg key={i} viewBox="0 0 24 24" className="w-5 h-5 fill-amber-400 text-amber-400">
...
function QuoteIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="testimonial-quote-icon w-10 h-10">
...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" ref={sectionRef} className="py-28 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div ref={introRef} className="text-center mb-16 px-6">
          <div className="section-label mb-5">
            <MessageIcon className="w-4 h-4" /> Testimonials
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">
            Review From Our Customers
          </h2>
          <p className="text-slate-400 text-base max-w-2xl mx-auto">
            Centered carousel showing 3 testimonials at a time with infinite loop and smooth transitions.
          </p>
        </div>

        <div ref={sliderRef} className="testimonial-carousel-shell relative px-4 md:px-8">
          <button
            type="button"
              ...
              <SwiperSlide key={t.name}>
                <article className="testimonial-slide-card rounded-4xl p-6 md:p-8 h-full">
                  ...
                  <div className="flex flex-col items-center text-center gap-5 md:gap-6">
                    <div className={`testimonial-avatar w-24 h-24 md:w-28 md:h-28 rounded-full ${t.avatarBg} flex items-center justify-center text-white text-2xl font-bold shrink-0`}>
                      {t.avatar}
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div>
                        <p className="testimonial-name text-xl font-bold mb-1">{t.name}</p>
